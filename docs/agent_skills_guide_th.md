...
1.  **นำคู่มือนี้หรือแนวคิดไปใช้:** สามารถนำโฟลเดอร์ `skills/` ไปคัดลอกลงในโปรเจกต์ของคุณ ภายใต้โฟลเดอร์ควบคุมของเอดิเตอร์ (เช่น `.cursor/skills/` หรือเรียกใช้ผ่าน `npx skills add addyosmani/agent-skills`)
