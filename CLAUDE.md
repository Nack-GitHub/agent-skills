...
> **Scope:** This file configures agents working on the [`Nack-GitHub/agent-skills`](https://github.com/Nack-GitHub/agent-skills) repository itself, not other projects. Don't copy it into another project or a global agent configuration; the reusable assets are the skills in `skills/`.
