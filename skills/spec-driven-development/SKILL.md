...
description: Creates specs, drafts PRDs, and defines project objectives and boundaries before coding. Use when starting a new project, feature, or significant change and no specification or PRD exists yet. Use when requirements are unclear, ambiguous, or only exist as a vague idea.
---
